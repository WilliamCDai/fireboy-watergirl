...
public class Player extends Rectangle{
	...
	/*public void loadImage() {
		ImageIcon ii = new ImageIcon("src//Images/Fireboy.png");
	...
	public void draw(Graphics2D g2D) {
		//g2D.setColor(colour); // set colour to white
		//g2D.fillRect(x, y, PlayerWidth, PlayerHeight); // draw the rectangle with the position and dimensions
		//destination.draw(g2D);
		
		// Not working image code
